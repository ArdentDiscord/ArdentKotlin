...
public enum Engine {
    ...
    JAVASCRIPT("JavaScript", "js", "javascript") {
        ...
        public Triple<Object, String, String> eval(final Map<String, Object> fields, final Collection<String> classImports, final Collection<String> packageImports, final int timeout, String script) {
            ...
            importString = new StringBuilder(KotlinUtilsKt.replaceLast(importString.toString(), ", ", ""));
    ...
    public static final Collection<String> DEFAULT_IMPORTS = Arrays.asList("net.dv8tion.jda.core.entities.impl", "net.dv8tion.jda.core.managers", "net.dv8tion.jda.core.entities", "net.dv8tion.jda.core", "java.lang", "java.io", "java.math", "java.util", "java.util.concurrent", "java.time", "java.lang.System");
